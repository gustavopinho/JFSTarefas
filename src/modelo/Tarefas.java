...
public class Tarefas implements Serializable {
    ...
    // Identifica se uma tarefa já foi concluída.
    private Boolean finalizada;
    
    // Identifica a data de cadastro da tarefa.
    private Timestamp cadastro;
    
    // Identifica à data que a tarefa foi entregue.
    private Timestamp entrega;
    
    // Identifica a data prevista para a entrega de uma tarefa.
